...
def test_get_github_latest_release_success(mocker):
    mocker.patch(
        "providers.github.get_github_latest_release", return_value=success_response
    )
...
def test_get_github_release_by_tag_name_success(mocker):
    mocker.patch(
        "providers.github.get_github_release_by_tag_name", return_value=success_response
    )
    response = providers.github.get_github_release_by_tag_name(
...
def test_get_github_latest_release_fail(mocker):
    mocker.patch(
        "providers.github.get_github_latest_release", return_value=fail_response
    )
    response = providers.github.get_github_latest_release(owner="owner", repo="repo")
...
def test_get_github_release_by_tag_name_fail(mocker):
    mocker.patch(
        "providers.github.get_github_release_by_tag_name", return_value=fail_response
    )
    response = providers.github.get_github_release_by_tag_name(
        owner="owner", repo="repo", tag="tag"
    )
